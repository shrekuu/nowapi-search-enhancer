        ...
        items: [
            {
                ...
                search_text: 'CNY;  Renminbi; ren min bi; 人民币',
                code: 'CNY'
            },
            {
                display_text: '美元, USD',
                search_text: 'USD;  Dollar; mei yuan; 美元',
                code: 'USD'
            },
            {
                display_text: '欧元, EUR',
                search_text: 'EUR;  EUR; ou yuan; 欧元',
                code: 'EUR'
            },
            {
                display_text: '英镑, GBP',
                search_text: 'GBP;  GBP; ying bang; 英镑',
                code: 'GBP'
            },
            {
                display_text: '港币, HKD',
                search_text: 'HKD;  Hong Kong dollar; gang bi; 港币',
                code: 'HKD'
            },
            {
                display_text: '台币, TWD',
                search_text: 'TWD;  Taiwan dollar; tai bi; 台币',
                code: 'TWD'
            },
            {
                display_text: '新加坡元, SGD',
                search_text: 'SGD;  Singapore dollar; xin jia po yuan; 新加坡元',
                code: 'SGD'
            },
            {
                display_text: '日元, JPY',
                search_text: 'JPY;  JPY; ri yuan; 日元',
                code: 'JPY'
            }
        ]
    },
